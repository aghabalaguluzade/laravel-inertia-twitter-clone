            ...
            <ul>
                <li class="cursor-pointer hover:bg-lowWhite px-2 py-2">
                    <div class="flex items-center justify-between">
                        <span class="text-[12px] font-bold">NFL</span>
                        <span class="text-[12px] text-lowsWhite">Final</span>
                    </div>
                    <div class="w-full overflow-hidden rounded-lg py-1">
                        <span class="flex items-center gap-3 text-sm justify-start font-bold bg-[#E14434] py-2">
                            <img src="/images/cleveland-browns.png" class="w-[40px]" alt="atlanta image">
                            Cleveland Browns
                        </span>
                        <span class="flex items-center gap-3 text-sm justify-start font-bold bg-[#007A33] py-2">
                            <img src="/images/philadelphia-eagles.png" class="w-[40px]" alt="boston image">
                            Philadelphia Eagles
                        </span>
                    </div>
                </li>
...
const trendsForYou = ref([
    { id: 1, trending: 'Currently Trending', title: 'GPT-4 Released', twitCount: '1000' },
    { id: 2, trending: 'Not Trending', title: 'Summer Vacation Deals', twitCount: '500' },
    { id: 3, trending: 'Currently Trending', title: 'New Movie Premiere', twitCount: '1500' },
    { id: 4, trending: 'Not Trending', title: 'Healthy Eating Tips', twitCount: '200' },
    { id: 5, trending: 'Currently Trending', title: 'SpaceX Rocket Launch', twitCount: '3000' },
])
